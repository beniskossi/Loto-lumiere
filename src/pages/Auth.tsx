...
const Auth = () => {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center p-4 bg-gradient-to-br from-background via-background to-primary/5">
      <Card className="w-full max-w-md bg-gradient-to-br from-card to-muted/20 border-border/50 shadow-sm animate-fade-in">
        <CardHeader className="space-y-1 text-center pb-4">
          ...
          <CardTitle className="text-2xl font-bold tracking-tight">LOTO LUMIÈRE</CardTitle>
          <CardDescription>
        ...
        <CardContent>
          <Tabs defaultValue="login" className="w-full">
            <TabsList className="grid w-full grid-cols-2 p-1.5 bg-muted/50 rounded-xl mb-4">
              <TabsTrigger value="login" className="rounded-lg data-[state=active]:shadow-sm">Connexion</TabsTrigger>
              <TabsTrigger value="signup" className="rounded-lg data-[state=active]:shadow-sm">Inscription</TabsTrigger>
            </TabsList>
