...
export const LocalPredictionEnginePanel = ({ drawName }: LocalPredictionEnginePanelProps) => {
  ...
  const [activeTab, setActiveTab] = useState<"prediction" | "params" | "sandbox">("prediction");
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex justify-center">
        <div className="bg-secondary/20 p-1 rounded-2xl border border-border/10 flex gap-1 w-full max-w-xl shadow-sm">
          <button
              ...
              <Card className="border-border/50 bg-card/60 backdrop-blur-xl shadow-md">
                <CardHeader className="pb-3">
                  <CardTitle className="flex items-center gap-2 text-lg font-bold tracking-tight">
                    ...
                    Poids des Piliers d'Analyse (F1 - F4)
                  </CardTitle>
                  <CardDescription>
                    Configurez l'influence de chaque équation stochastique sur le score combiné final.
                  </CardDescription>
                </CardHeader>
                <CardContent className="space-y-5">
                  ...
                  <div className="space-y-1.5">
                    ...
                    <p className="text-[10px] text-muted-foreground/80 leading-relaxed">
                      Poids accordé aux occurrences passées avec correction bayésienne et taux d'amortissement exponentiel.
                    </p>
                  </div>
                  ...
                  <div className="space-y-1.5">
                    ...
                    />
                    <p className="text-[10px] text-muted-foreground/80 leading-relaxed">
                      Poids sur l'intervalle d'écart modélisé par une distribution stochastique de Weibull.
                    </p>
                  </div>
                  ...
                  <div className="space-y-1.5">
                    ...
                    />
                    <p className="text-[10px] text-muted-foreground/80 leading-relaxed">
                      Modélisation probabiliste séquentielle avec lissage bayésien de Laplace (Ordre 1 ou 2).
                    </p>
                  </div>
                  ...
                  <div className="space-y-1.5">
                    <div className="flex justify-between items-center text-xs">
                      <span className="font-semibold flex items-center gap-1.5 text-foreground/90">
                        ...
                        Poids Régression Moyenne Spatiale (F4)
                      </span>
                    ...
                    />
                    <p className="text-[10px] text-muted-foreground/80 leading-relaxed">
                      Force de retour à la moyenne (Ornstein-Uhlenbeck) régie par l'asymétrie spatiale des lignes et colonnes.
                    </p>
                  </div>
                  ...
                  <div className="border-t border-border/40 pt-4 space-y-4">
                    <h4 className="text-[11px] font-bold uppercase tracking-wider text-muted-foreground/90 flex items-center gap-1.5">
                      ...
                      Calibrage des Hyper-Paramètres Algorithmiques
                    </h4>
                    ...
                    <div className="space-y-1.5">
                      <div className="flex justify-between items-center text-xs">
                        <span className="text-muted-foreground font-medium">Profondeur de l'historique de calcul</span>
